      ...
      <div className="flex items-center justify-center gap-1 sm:gap-2 mt-6 flex-wrap">
        ...
        {startPage > 1 && (
          <>
            ...
            {startPage > 2 && <span className="text-gray-500 text-sm sm:text-base">...</span>}
          </>
        )}
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
        <form onSubmit={handleSearch} className="flex gap-2 sm:gap-3 flex-1">
          <input
            type="text"
            value={query}
        ...
        {searchType === 'albums' && albumResults.length > 0 && (
          <select
            ...
            className="h-10 sm:h-12 px-3 sm:px-4 text-sm sm:text-base rounded-lg bg-[#1e1e1e] border border-(--primary) text-white focus:outline-none focus:ring-2 focus:ring-(--primary) cursor-pointer"
          >
