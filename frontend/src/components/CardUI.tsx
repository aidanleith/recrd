...
function CardUI()
{
    ...
    async function addCard(e:any) : Promise<void>
    {
        ...
        console.log('Sending to API:', { userId, card });
    ...
    return(
        ...
        <br />
            ...
            <button type="button" id="searchCardButton" className="buttons" onClick={searchCard}></button>
        <br />
            <span id="cardSearchResult">{searchResults}</span>
            <p id="cardList">{cardList}</p><br /><br />
            <input type="text" id="cardText" placeholder="Card To Add" onChange={handleCardTextChange} />
            <button type="button" id="addCardButton" className="buttons" onClick={addCard}></button>
        <br />
